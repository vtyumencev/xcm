...
<section class="xcm-manager xcm-vendor">
    <div class="xcm-manager__desc">
        ...
        <div class="xcm-vendor-links">
            <a class="xcm-vendor-links__link" href="<?php echo $vendor->link; ?>" target="_blank">
                ...
                <span class="xcm-vendor-links__link-label">
        ...
        <?php if ($vendor->cookies): ?>
            <div class="xcm-manager-cookies">
                <div class="xcm-manager-cookies__header">
                    <div class="xcm-manager-cookies"><?php echo __("Cookie name", 'xcm'); ?></div>
                    <div class="xcm-manager-cookies"><?php echo __("Duration", 'xcm'); ?></div>
                </div>
                <div class="xcm-manager-cookies__list">
                    <?php foreach ($vendor->cookies as $cookie): ?>
                        <div class="xcm-manager-cookies__item xcm-manager-cookie">
                            <div class="xcm-manager-cookie__heading">
                                <?php echo $cookie->name; ?>
                            </div>
                            <div class="xcm-manager-cookie__duration">
